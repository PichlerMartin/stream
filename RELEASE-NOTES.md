...
#### scheduled Date: 24/02/2020

### New Features:

* added several improvements
* added some interesting new features
* worked on main documentation

### Bug Fixes/Improvements:

* to be added soon
* this release version is currently being worked on and will be released at the scheduled date
